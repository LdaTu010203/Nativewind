    ...
    <View>
      <FlatList
        ...
        renderItem={(product: {
          ...
          <TouchableOpacity
            onPress={() => router.push("/molecules/items")}
            className="bg-Dark-header rounded-3xl justify-center items-center flex-1 flex flex-row px-5 py-3 mb-3"
          >
            <Image
            ...
            <View className="flex-1 flex flex-col pl-5">
              <Text className="font-PolyRegular text-xl text-Dark-textTitle self-center">
                {product.item.name}
              </Text>
              <Text className="font-PolyRegular text-Dark-textContent text-xl self-center">
                {product.item.price}.000đ
              </Text>
              <Text className="font-PolyRegular text-Dark-Background text-xs self-center pt-2">
                OfficalStore-VIETGANGZ
              </Text>
              <Text className="font-PolyRegular text-Dark-Background text-xs self-center">
